...
- Global Project Readiness Assistant (independent product concept): explored three AI product ideas for
  global project management, ruling out two after finding a saturated AI incident-communication market
  and a mature enterprise FX-risk software category. Identified a genuine gap — project-level global
  readiness (holidays, decision culture, data residency) for cross-border teams. Scoped the concept as an
  AI-generated readiness brief plus a human-approved calendar push, deliberately avoiding a from-scratch
  scheduling engine — a call validated when Salesforce's 2026 acquisition and shutdown of Clockwise
  confirmed standalone calendar-AI is a feature platforms absorb, not a durable product. Built interactive
  prototypes of both the readiness brief and the approval flow to test the concept.
